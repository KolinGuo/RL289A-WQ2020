...
#        self.boxes_on_target = current_boxes_on_target
    ...
    def _calc_reward(self):
        ...
        if game_won:
            ...
            # Add the reward if a box is pushed on the target
            self.reward_last = self.reward_box_on_target
        elif current_boxes_on_target < self.boxes_on_target:
    ...
    def set_rewards(self, rewards):
        assert len(rewards) == 4, 'Wrong number of rewards, should be 4'

        self.penalty_for_step = rewards[0]
        self.reward_box_on_target = rewards[1]
        self.penalty_box_off_target = rewards[2]
        self.reward_finished = rewards[3]
